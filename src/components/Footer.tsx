    ...
    <footer className="relative py-20 pb-10 z-10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-16">
          <div className="backdrop-blur-md bg-studio-black/30 p-6 border border-blue-500/20 rounded-lg relative overflow-hidden">
          ...
          <div className="backdrop-blur-md bg-studio-black/30 p-6 border border-purple-500/20 rounded-lg relative overflow-hidden">
            <div className="absolute inset-0 w-full h-full">
              <EvervaultCard text="Labs" />
            </div>
            <div className="relative z-10">
          ...
          <div className="backdrop-blur-md bg-studio-black/30 p-6 border border-pink-500/20 rounded-lg relative overflow-hidden">
            <div className="absolute inset-0 w-full h-full">
