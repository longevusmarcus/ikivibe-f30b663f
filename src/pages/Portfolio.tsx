      ...
      <div className="pt-24">
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div id="rocket-minds" ref={rocketMindsRef} className="mt-20 scroll-mt-24 relative">
              ...
              <p className="text-xl max-w-3xl mb-6 text-studio-lightgray">
                We help young talents and startups stay true to their purpose while building with a long-term vision.
                With hands-on support, we turn unique ideas into real products, often in just days, and guide them
                toward sustainable growth. By aligning passion, skill, mission, and market need, we help both visionary
                executers and pre-series A ventures grow with purpose and a mindset rooted in longevity.
              </p>
