...
export default function Hero() {
  const fullText =
    "The future belongs to those who connect the dots. Our mission is to build a world where ideas survive, humans thrive, and wealth endures, across generations.";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col space-y-6 max-w-4xl">
          <h1 className="font-display font-bold tracking-tighter animate-fade-in">
            <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl">Unlock • Human • Potential</span>
            <br />
            <span className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl text-studio-lightgray whitespace-nowrap">
              build forever things
            </span>
          </h1>
